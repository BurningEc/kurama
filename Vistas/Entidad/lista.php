          ...
          <?php 
            ...
            while ($row=mysqli_fetch_array($query))
              ...
              <tr>
                ...
                <td><?php echo $row['descripcion_E'];?></td>
                <td><img style="height: 100px;width: 100px;" src="data:image/jpg;base64,<?php echo $row['imagen_E'];?>"></td>
                <td>
                  <a class="btn btn-info" href="actualizar.php?id=<?php echo $row['idEntidad'];?>"><i class="fas fa-cog"> Editar</i></a>
                </td>
                <td>
                  <a class="btn btn-dark" href="controlador.php?eliminar=true&id=<?php echo $row['idEntidad'];?>"><i class="fas fa-trash-alt"> Eliminar</i></a>
                </td>
              </tr>
          <?php
            }?>
