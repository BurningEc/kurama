...
<?php
  ...
  function Consultar($id)
  {
    ...
    $sentencia="SELECT * FROM directivo WHERE idDirectivo='".$id."' ";
...
<form action="controlador.php" method="POST" name="form" enctype="multipart/form-data" >
      ...
      <div class="form-group row">
        <label for="inputPassword3" class="col-sm-2 col-form-label">Cargo:</label>
        <div class="col-sm-10">
          <input type="text" name="cargo" value="<?php echo $consulta[2]?>" required>
        </div>
      </div>
