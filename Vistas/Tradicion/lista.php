        ...
        while ($row1=mysqli_fetch_array($query1))
          {
            ...
            $response.="<td><img style='height: 100px;width: 100px;'' src='data:image/jpg;base64,".$row1['imagen_T']."'></td>";
                     $response.="<td><a class='btn btn-info' href='actualizar.php?id=".$row1['idTradicion']."'>Editar</a></td>";
            $response.="<td><a class='btn btn-dark' href='controlador.php?eliminar=true&id=".$row1['idTradicion']."'>Eliminar </a></td>";
            $response.="</tr>";    
          }
      }            
    exit($response);
...
<a href="crear.php" class="btn btn-warning" ><i class="fas fa-plus"> Agregar</i></a>
  <a href="javascript:lista()" class="btn btn-success"  style="float: right;">Buscar</a>
