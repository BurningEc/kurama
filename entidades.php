          ...
          ?>
            <div class="col-lg-3 col-md-4 col-sm-6 portfolio-item">
              <div class="card h-100">
                <a href="#"><img class="card-img-top" style="height: 200px;width: 250px;" src="data:image/jpg;base64,<?php echo $row['imagen_E'];?>" alt=""></a>
                <div class="card-body" align="center">
                  <h4 class="card-title">
                    <a href="#"><?php echo $row['nombre_E'];?></a>
                  </h4>
                  <p class="card-text" align="justify" ><?php echo $row['descripcion_E'];?>
                     </p>
                </div>
              </div>
            </div>
