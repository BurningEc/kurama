          ...
          ?>
            <div class="col-lg-3 col-md-4 col-sm-6 portfolio-item">
              <div class="card h-100">
                <a href="#"><img class="card-img-top" src="data:image/jpg;base64,<?php echo $row['imagen_C'];?>"></a>
                <div class="card-body" align="center">
                  <h4 class="card-title">
                    <a href="#"><?php echo $row['nombre_C'];?></a>
                  </h4>
                  <p class="card-text" align="center" ><?php echo $row['descripcion_C'];?></p>
                </div>
              </div>
            </div>
        <?php
